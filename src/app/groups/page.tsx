  ...
  return (
    <div className="max-w-6xl mx-auto p-4 mt-6">
      <div className="flex justify-between items-center mb-8">
        ...
        <form action={async (fd) => { 'use server'; await createGroup(fd); }} className="flex gap-2">
          <input 
            name="name" 
          ...
          />
          <button type="submit" className="bg-blue-600 text-white px-4 py-2 rounded-md font-semibold flex items-center gap-1 text-sm hover:bg-blue-700">
