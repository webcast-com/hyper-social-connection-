  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center justify-center gap-1.5 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-100 px-3 sm:px-4 py-2 rounded-lg font-semibold text-sm transition-colors w-full sm:w-auto"
      >
