...
export async function ensureSeeded() {
  ...
  try {
    ...
    const insertedUsers = await db.insert(users).values([
      { name: 'Alex Rivera',    email: 'alex@example.com',   password, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Alex',   coverPhoto: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=80', bio: '📸 Photography enthusiast | ☕ Coffee addict | 🌍 World traveler.' },
      { name: 'Maya Patel',      email: 'maya@example.com',   password, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Maya',   coverPhoto: 'https://images.unsplash.com/photo-1501854140801-50d01698950b?w=1200&q=80', bio: '🎨 Digital artist and designer.' },
      { name: 'Jordan Kim',      email: 'jordan@example.com', password, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jordan', coverPhoto: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=1200&q=80', bio: '🏋️ Fitness coach and wellness advocate.' },
      { name: 'Sophie Chen',     email: 'sophie@example.com', password, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sophie', coverPhoto: 'https://images.unsplash.com/photo-1490750967868-88df5691cc11?w=1200&q=80', bio: '👩‍💻 Full-stack engineer.' },
      { name: 'Marcus Lee',      email: 'marcus@example.com', password, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Marcus', coverPhoto: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1200&q=80', bio: '🎸 Musician and content creator.' },
    ]).returning();
    ...
    const [alex, maya, jordan, sophie, marcus] = insertedUsers;
      ...
      { postId: insertedPosts[5].id, userId: maya.id },
